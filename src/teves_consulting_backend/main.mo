...
import RoleBasedIntelligenceStatus "lib/RoleBasedIntelligenceStatus";
import RoleRulesOperatingAgreementStatus "lib/RoleRulesOperatingAgreementStatus";
...
actor {
  ...
  public shared query ({ caller }) func getAionRoleBasedIntelligenceStatus() : async RoleBasedIntelligenceStatus.Report {
    OperatorAccess.requireOperator(caller);
    RoleBasedIntelligenceStatus.report();
  };

  public shared query ({ caller }) func getAionRoleRulesOperatingAgreementStatus() : async RoleRulesOperatingAgreementStatus.Report {
    OperatorAccess.requireOperator(caller);
    RoleRulesOperatingAgreementStatus.report();
  };
